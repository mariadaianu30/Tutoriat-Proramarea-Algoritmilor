# 🐍 20 de Probleme cu Seturi în Python

De la ușor la complex — fiecare problemă include **descriere**, **exemplu de input** și **output**.

---

## 🟢 Nivel 1 – Începător (operații de bază cu seturi)
